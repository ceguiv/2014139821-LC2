...
namespace _2014139821_MVC.Controllers
{
    public class DistritoesController : Controller
    {
        ...
        {
            //ViewBag.ProvinciaId = new SelectList(db.Provincias, "ProvinciaId", "CadenaUbigeo");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "DistritoId,ProvinciaId,UbigeoId")] Distrito distrito)
        {
            ...
            //ViewBag.ProvinciaId = new SelectList(db.Provincias, "ProvinciaId", "CadenaUbigeo", distrito.ProvinciaId);
            return View(distrito);
        }
